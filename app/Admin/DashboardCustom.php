...
class DashboardCustom
{
    ...
    {
        $uril;
        foreach (DB::table('url')->select('link')->where('name', '=' ,'manual')->get() as $uri) {
                $uril = $uri->link;
            } 
        $extensions = [
            'manual' => [
                'name' => 'Manual de usabilidad',
                'link' => $uril,
                'icon' => 'book',
            ],
