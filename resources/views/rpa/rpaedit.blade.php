...
<form class="form-horizontal" method="post"  autocomplete="off">
    ...
    <div class="row" style="display: none;">
        ...
        <div class="col-75">
            <input type="text" id="sis" name="sis" placeholder="Sistema destino"  value="<?php echo $sis ?>">
        </div>
    </div>
       ...
       <div class="row">
        ...
        <div class="col-75">
            <input type="number" id="sleep" name="sleep" placeholder="Tiempo de espera" value="{{$time}}" >
        </div>
    </div>
    ...
    <div class="row" id="hosti">
        ...
        <div class="col-75">
            <input type="text" id="host" name="host" placeholder="Host" value="<?php echo $host ?>">
        </div>
    </div>
    ...
    <div class="row" id="driveri">
        ...
        <div class="col-75">
            <input type="text" id="driverlocation" name="driverlocation" placeholder="Driver Location" value="<?php echo $driver ?>">
        </div>
    </div>
    ...
    <div class="row" id="downloadi">
        ...
        <div class="col-75">
            <input type="text" id="download" name="download" placeholder="Location download" value="<?php echo $download ?>">
        </div>
    ...
    <div class="row" id="multiplexi">
        ...
        <div class="col-75">
            <?php echo $check ?>
            <!--<input type="checkbox" id="multiplex" checked>Si lo selecciona este se encargara de ejecutar operaciones repetitivas--> 
        </div>
    </div>
    <div class="row" id="cargcsv">
        ...
        <div class="col-75">
            <input type="text" id="csv" name="csv" placeholder="Cargar csv" value="<?php echo $csv ?>">
        </div>
    </div>
...
<div class="row" id="calendarizai">
    ...
    <div class="row">
        ...
        <a onClick="enviarDatas()" type="button" id="btn-enviar" name="btn-enviar" class="btn btn-info">Enviar y seguir editando</a>
        ...
        if (type == 0) {
            ...
            if (type == 1 || type == 4) {
                if (pass == "") {
                    ...
                    $.post("/admin/rpedit", {id: id, csv: csv, type: type, multiplex: multiplex, sis: sis, name: name, pass: pass, host: host, user: user,sleep:sleep})
                            .done(function (data) {
                                if (data == 'bien') {
                                    Swal.fire(
                                            'Envio correcto',
                ...
                if (download == "") {
                    ...
                    $.post("/admin/rpedit", { id: id, csv: csv, multiplex: multiplex, type: type, sis: sis, name: name, download: download, driver: driver,sleep:sleep})
                            .done(function (data) {
                                if (data == 'bien') {
                                    Swal.fire(
                                            'Envio correcto',
                ...
                if (driver == "") {
                    ...
                    $.post("/admin/rpedit", {id: id, csv: csv, multiplex: multiplex, type: type, sis: sis, name: name, driver: driver,sleep:sleep})
                            .done(function (data) {
                                if (data == 'bien') {
                                    Swal.fire(
                                            'Envio correcto',
